...
public class ServiceTests
{
    ...
    [Fact] 
    public void CreateTicket_ForNonExistantStudent_ShouldNotBeCreated()
    {
        // arrange

        // act
        var t = svc.CreateTicket(999, "Dummy Ticket 1");
    ...
    public void DeleteTicket_WhenValid_ShouldBeRemovedFromStudent()
    {
        ...
        // arrange
        var s = svc.AddStudent(
            new Student { Name="AAA", Course="Maths", Email="AAA@email.com", Age=20, Grade=40}
        );

        var t = svc.CreateTicket(s.Id, "Test Ticket 1");

        // act
        
        svc.DeleteTicket(t.Id); 
        var st=svc.GetStudent(s.Id);
